...
public class Encryption
{
	public static void main (String[]args)
  {
		...
		try {
	  	String data_file = "data/plaintext.txt", encrypted_file = "data/encrypt.txt", decrypted_file = "data/decrypt.txt", incorrect_file = "data/incorrect.txt", avalanche_data_file = "data/ava_plain.txt", avalanche_encrypted_file = "data/ava_encrypt.txt";
